...
import com.cg.mljrpt.admin.api.feign.RemoteUserService;
...
public class MljrptAppUserDetailsServiceImpl implements MljrptUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (MljrptUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(MljrptUser mljrptUser) {
		return this.loadUserByUsername(mljrptUser.getPhone());
	}
