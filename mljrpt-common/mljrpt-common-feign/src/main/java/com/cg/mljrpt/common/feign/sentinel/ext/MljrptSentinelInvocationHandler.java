...
import com.cg.mljrpt.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class MljrptSentinelInvocationHandler implements InvocationHandler {
	...
	MljrptSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MljrptSentinelInvocationHandler other = (MljrptSentinelInvocationHandler) obj;
